...
// it changes the mode of the project -- Light mode to dark mode and vice versa

document.addEventListener('DOMContentLoaded', function() {
    const modeChangeDiv = document.querySelector('.modeChange');
    let isDarkMode = false;
    const favouriteElement = document.getElementById('favourites-body');
  
    modeChangeDiv.addEventListener('click', function() {
      // Toggle the background color of the body
      if (isDarkMode) {
        document.querySelector(".modeChange .fa-moon").id = "";
		document.querySelector(".modeChange .fa-sun").id = "hide";
        document.body.style.backgroundColor = 'aliceblue';
     
      } 
      else {
        document.querySelector(".modeChange .fa-sun").id = "";
		document.querySelector(".modeChange .fa-moon").id = "hide";
      ...
      if (isDarkMode) {
        document.body.style.color = 'white'; // Set the text color for dark mode
      } else {
        document.body.style.color = 'black'; // Set the text color for light mode
      }

      if (isDarkMode) {
        favouriteElement.style.backgroundColor = 'black'; // Set the text color for dark mode
      } else {
        favouriteElement.style.backgroundColor = 'aliceblue'; // Set the text color for light mode
      }
